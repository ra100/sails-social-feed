...
module.exports = function forbidden (data, options) {
  ...
  if (data !== undefined) {
    sails.log.verbose('Sending 429 ("Too Many Requests") response: \n',data);
  }
  else sails.log.verbose('Sending 429 ("Too Many Requests") response');
  ...
  else return res.view('429', { data: data }, function (err, html) {
